        ...
        function: {
          ...
          parameters: {
            ...
            properties: {
              ...
              phone: { type: 'string', description: 'The phone number exactly as the client wrote it, spaces and all. Never judge it yourself: send it and the server checks it.' },
            },
          },
        },
      }
      ...
      function: {
        ...
        parameters: {
          ...
          properties: stringProps([
            ...
            ['phone', 'The phone number exactly as the client wrote it, spaces and all. Never judge it yourself: send it and the server checks it.'],
          ]),
        },
      },
    });
