...
// nowLabel, freeSlots and todayYmd take the moment as an argument and read nothing else: given the
// same `now` they answer the same thing on any day, which is what lets a benchmark pin the clock and
// compare two runs. The `= new Date()` defaults are the only reading of the real clock in this file.
