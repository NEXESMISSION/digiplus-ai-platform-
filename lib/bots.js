...
const BOTS = {
  'clim-express': {
    ...
    welcome: ['Aslema 😊 Marhbe bik fi Clim Express', 'Chnowa t7eb: installation, entretien wala réparation?'],
  ...
  'yasmine-photo': {
    ...
    welcome: ['Ahla 😊 Marhbe bik', 'Chnowa el séance elli t7ebha: portrait, famille wala grossesse?'],
    starters: ['N7eb shooting famille', '9adech el portrait?', 'Ay nhar famma place?'],
    profile: {
  ...
  digiplus: {
    ...
    demo: false,
    brain: 'digiplus.md',
    welcome: ['Aslema 😊 Marhbe bik fi DigiPlus', 'T7eb chat kima hedha lel activité mte3ek?'],
    ...
    profile: {
      ...
      skills: ['Explique comment ça marche', 'Donne les tarifs', 'Saif vous rappelle'],
      hours: 'Répond 24h/24',
    },
    details: {
      fields: [
      ...
      footer: () => 'Saif de DigiPlus vous appelle très vite',
    },
  },
};
