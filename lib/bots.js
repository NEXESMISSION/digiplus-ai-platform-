...
const BOTS = {
  'clim-express': {
    ...
    welcome: ['Aslema 😊 Marhbe bik fi Clim Express', 'Chnowa t7eb ta3mel: installation, entretien, réparation wala recharge gaz?'],
    starters: ['El clim ma3adech tbarred', 'N7eb nrakkeb clim', '9adech el entretien?'],
    profile: {
      kind: 'Entreprise de services · Sfax',
      photo: '/img/clim.webp',
      about: 'Installation, entretien, réparation et recharge de gaz pour climatiseurs, à domicile.',
  ...
  'yasmine-photo': {
    ...
    starters: ['N7eb shooting famille', '9adech el portrait?', 'Anahi nhar famma place?'],
    profile: {
  ...
  digiplus: {
    ...
    demo: false,
    // The only assistant that sells a subscription (39/99/199 dt fel chhar): validate.js's
    // FEE-UNEXPLAINED runs on this flag alone, so a monthly price here must say what it covers.
    recurring: true,
    brain: 'digiplus.md',
